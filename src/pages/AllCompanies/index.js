              ...
              {apiData?.map((apiDataResponseEle, index) => {
                return (
                  <React.Fragment key={`apiDataResponseEle${index}`}>
                    <div className="bg-white_A700 border border-gray_200 border-solid flex flex-1 flex-col items-start justify-start my-[0] p-[8px] w-[100%]">
                      <div className="flex md:flex-col sm:flex-col flex-row gap-[16px] items-center justify-start w-[100%]">
                        <Img
                          src="images/img_ochkn9v1.png"
                          ...
                          <div className="flex md:flex-col sm:flex-col flex-row gap-[32px] items-center justify-start p-[10px] w-[100%]">
                            <div className="flex flex-1 flex-col gap-[3px] items-start justify-start md:self-stretch sm:self-stretch w-[100%]">
                              ...
                              >
                                ...
                                traceability, and an overall improved
                                procurement experience for both supply and
                                demand.
                              </Text>
                            </div>
                            <Img
